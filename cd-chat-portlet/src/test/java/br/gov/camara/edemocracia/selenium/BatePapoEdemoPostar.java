...
public class BatePapoEdemoPostar implements Runnable {
	private static final String USUARIO = "userPostar";
	private static final String EMAIL = USUARIO + "@teste.br";
	
	public static void main(String[] args) throws Exception {

		for (int cont = 0; cont < 5; cont++) {
			Thread thread = new Thread(new BatePapoEdemoPostar(cont));
			thread.start();
		}
	}
	...
	public BatePapoEdemoPostar(int cont) {
		this.cont = cont;
	}
