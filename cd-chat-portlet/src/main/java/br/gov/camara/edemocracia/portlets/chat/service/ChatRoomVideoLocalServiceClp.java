...
public class ChatRoomVideoLocalServiceClp implements ChatRoomVideoLocalService {
    ...
    public ChatRoomVideoLocalServiceClp(
    ...
    public br.gov.camara.edemocracia.portlets.chat.model.ChatRoomVideo addChatRoomVideo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(chatRoomVideo) });
        } catch (Throwable t) {
        ...
        return (br.gov.camara.edemocracia.portlets.chat.model.ChatRoomVideo) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public br.gov.camara.edemocracia.portlets.chat.model.ChatRoomVideo fetchChatRoomVideo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName9,
                    _methodParameterTypes9, new Object[] { videoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<br.gov.camara.edemocracia.portlets.chat.model.ChatRoomVideo> getChatRoomVideos(
        ...
        return (java.util.List<br.gov.camara.edemocracia.portlets.chat.model.ChatRoomVideo>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public br.gov.camara.edemocracia.portlets.chat.model.ChatRoomVideo updateChatRoomVideo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName15,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(chatRoomVideo),
    ...
    public br.gov.camara.edemocracia.portlets.chat.model.ChatRoomVideo getVideo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    _methodParameterTypes19, new Object[] { videoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
