...
/**
 * The base implementation of the chat room user local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.gov.camara.edemocracia.portlets.chat.service.impl.ChatRoomUserLocalServiceImpl}.
 * </p>
 *
 * @author Ricardo Lima
 ...
 * @generated
 */
public abstract class ChatRoomUserLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ChatRoomUserLocalService,
        IdentifiableBean {
    ...
    private ChatRoomUserLocalServiceClpInvoker _clpInvoker = new ChatRoomUserLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link br.gov.camara.edemocracia.portlets.chat.service.ChatRoomUserLocalServiceUtil} to access the chat room user local service.
     */
    ...
    public ChatRoomUser addChatRoomUser(ChatRoomUser chatRoomUser)
        throws SystemException {
        chatRoomUser.setNew(true);

        return chatRoomUserPersistence.update(chatRoomUser, false);
    }
     ...
     */
    public ChatRoomUser createChatRoomUser(long chatUserId) {
        return chatRoomUserPersistence.create(chatUserId);
    }
    ...
    public ChatRoomUser deleteChatRoomUser(long chatUserId)
        throws PortalException, SystemException {
        return chatRoomUserPersistence.remove(chatUserId);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public ChatRoomUser deleteChatRoomUser(ChatRoomUser chatRoomUser)
        throws SystemException {
        return chatRoomUserPersistence.remove(chatRoomUser);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(ChatRoomUser.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return chatRoomUserPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return chatRoomUserPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public ChatRoomUser fetchChatRoomUser(long chatUserId)
        throws SystemException {
        return chatRoomUserPersistence.fetchByPrimaryKey(chatUserId);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public ChatRoomUser getChatRoomUser(long chatUserId)
        throws PortalException, SystemException {
        return chatRoomUserPersistence.findByPrimaryKey(chatUserId);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return chatRoomUserPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<ChatRoomUser> getChatRoomUsers(int start, int end)
        throws SystemException {
        return chatRoomUserPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getChatRoomUsersCount() throws SystemException {
        return chatRoomUserPersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public ChatRoomUser updateChatRoomUser(ChatRoomUser chatRoomUser)
        throws SystemException {
        return updateChatRoomUser(chatRoomUser, true);
    }
    ...
    public ChatRoomUser updateChatRoomUser(ChatRoomUser chatRoomUser,
        ...
        return chatRoomUserPersistence.update(chatRoomUser, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("br.gov.camara.edemocracia.portlets.chat.model.ChatRoomUser",
            chatRoomUserLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = chatRoomUserPersistence.getDataSource();
