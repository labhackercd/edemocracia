...
public class ChatRoomMessageLocalServiceClp
    ...
    public ChatRoomMessageLocalServiceClp(
        ...
        _methodName19 = "getNullMessage";

        _methodParameterTypes19 = new String[] {  };

        _methodName20 = "postMessage";
        ...
        _methodName22 = "getMessagesForUserSince";
        ...
        _methodName23 = "getMessagesForUserUntil";
    ...
    public br.gov.camara.edemocracia.portlets.chat.model.ChatRoomMessage addChatRoomMessage(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(chatRoomMessage) });
        } catch (Throwable t) {
    ...
    public br.gov.camara.edemocracia.portlets.chat.model.ChatRoomMessage createChatRoomMessage(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { chatMessageId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public br.gov.camara.edemocracia.portlets.chat.model.ChatRoomMessage deleteChatRoomMessage(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { chatMessageId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public br.gov.camara.edemocracia.portlets.chat.model.ChatRoomMessage fetchChatRoomMessage(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName9,
                    _methodParameterTypes9, new Object[] { chatMessageId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public br.gov.camara.edemocracia.portlets.chat.model.ChatRoomMessage getChatRoomMessage(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { chatMessageId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<br.gov.camara.edemocracia.portlets.chat.model.ChatRoomMessage> getChatRoomMessages(
        ...
        return (java.util.List<br.gov.camara.edemocracia.portlets.chat.model.ChatRoomMessage>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public br.gov.camara.edemocracia.portlets.chat.model.ChatRoomMessage updateChatRoomMessage(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName15,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(chatRoomMessage),
    ...
    public void postMessage(
        ...
        try {
            _invokableLocalService.invokeMethod(_methodName20,
                ...
                ClpSerializer.translateInput(recipient),
