...
public class ChatRoomUserLocalServiceClp implements ChatRoomUserLocalService {
    ...
    public ChatRoomUserLocalServiceClp(
        ...
        _methodName22 = "findByPortalUser";
    ...
    public br.gov.camara.edemocracia.portlets.chat.model.ChatRoomUser addChatRoomUser(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(chatRoomUser) });
        } catch (Throwable t) {
    ...
    public br.gov.camara.edemocracia.portlets.chat.model.ChatRoomUser createChatRoomUser(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { chatUserId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public br.gov.camara.edemocracia.portlets.chat.model.ChatRoomUser deleteChatRoomUser(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { chatUserId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public br.gov.camara.edemocracia.portlets.chat.model.ChatRoomUser fetchChatRoomUser(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName9,
                    _methodParameterTypes9, new Object[] { chatUserId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public br.gov.camara.edemocracia.portlets.chat.model.ChatRoomUser getChatRoomUser(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { chatUserId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<br.gov.camara.edemocracia.portlets.chat.model.ChatRoomUser> getChatRoomUsers(
        ...
        return (java.util.List<br.gov.camara.edemocracia.portlets.chat.model.ChatRoomUser>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public br.gov.camara.edemocracia.portlets.chat.model.ChatRoomUser updateChatRoomUser(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName15,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(chatRoomUser),
