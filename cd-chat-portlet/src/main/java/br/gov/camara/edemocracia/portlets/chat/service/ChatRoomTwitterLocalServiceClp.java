...
public class ChatRoomTwitterLocalServiceClp
    ...
    public ChatRoomTwitterLocalServiceClp(
    ...
    public br.gov.camara.edemocracia.portlets.chat.model.ChatRoomTwitter addChatRoomTwitter(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(chatRoomTwitter) });
        } catch (Throwable t) {
        ...
        return (br.gov.camara.edemocracia.portlets.chat.model.ChatRoomTwitter) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public br.gov.camara.edemocracia.portlets.chat.model.ChatRoomTwitter createChatRoomTwitter(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { twitterId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public br.gov.camara.edemocracia.portlets.chat.model.ChatRoomTwitter deleteChatRoomTwitter(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { twitterId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public br.gov.camara.edemocracia.portlets.chat.model.ChatRoomTwitter fetchChatRoomTwitter(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName9,
                    _methodParameterTypes9, new Object[] { twitterId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public br.gov.camara.edemocracia.portlets.chat.model.ChatRoomTwitter getChatRoomTwitter(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { twitterId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<br.gov.camara.edemocracia.portlets.chat.model.ChatRoomTwitter> getChatRoomTwitters(
        ...
        return (java.util.List<br.gov.camara.edemocracia.portlets.chat.model.ChatRoomTwitter>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public br.gov.camara.edemocracia.portlets.chat.model.ChatRoomTwitter updateChatRoomTwitter(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName15,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(chatRoomTwitter),
    ...
    public br.gov.camara.edemocracia.portlets.chat.model.ChatRoomTwitter getTwitter(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    _methodParameterTypes19, new Object[] { twitterId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
