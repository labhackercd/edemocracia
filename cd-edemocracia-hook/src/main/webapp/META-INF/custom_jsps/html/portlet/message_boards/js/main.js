		...
		bbCode.prototype = {
			...
			_createToolbar: function() {
				...
				instance._buttons = {
					...
					youtube: {
						image: 'message_boards/youtube.png',
						onClick: function(event) {
							instance._insertVideo();
						},
						text: Liferay.Language.get('youtube')
					},			
			...
			_insertVideo: function() {
				...
				var url = prompt(Liferay.Language.get('enter-youtube-address'), 'http://www.youtube.com/v');

				if (url != null) {
					instance._resetSelection();
					instance.insertTag('youtube', null, url);
				}
			},
