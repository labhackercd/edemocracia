...
<%@ include file="/html/portlet/message_boards/config_label_preferences.jsp" %>
...
<aui:form action="<%= configurationURL %>" method="post" name="fm" onSubmit='<%= "event.preventDefault(); " + renderResponse.getNamespace() + "saveConfiguration();" %>'>
	...
	<liferay-ui:tabs
		names="general,email-from,message-added-email,message-updated-email,thread-priorities,user-ranks,rss,terms-used"
		param="tabs2"
		url="<%= portletURL %>"
	/>
	...
	<c:choose>
		...
		<c:when test='<%= tabs2.equals("terms-used") %>'>			
				<br />				
   		 	    <aui:fieldset>
					<h6>Links Superiores</h6>
					<aui:fieldset column="true" >
						<aui:input cssClass="lfr-input-text-container" label="Mensagens recentes" name="label-recent-posts" value="<%= labelRecentPosts %>"   />
					</aui:fieldset>				
				</aui:fieldset>
				...
				<aui:fieldset>
					<h6>Botões</h6>
					<aui:fieldset column="true" >
						<aui:input cssClass="lfr-input-text-container" label="Adicionar Categoria" name="label-add-category" value="<%= labelForumAddCategory %>"   />
						<aui:input cssClass="lfr-input-text-container" label="Postar novo tópico" name="label-post-new-thread" value="<%= labelPostNewThread %>"   />									
					</aui:fieldset>
					<aui:fieldset column="true" >
						<aui:input cssClass="lfr-input-text-container" label="Adicionar Subcategoria" name="label-add-subcategory" value="<%= labelForumAddSubcategory %>"  />						
					</aui:fieldset>
				</aui:fieldset>
				...
				<aui:fieldset>
					<h6>Termos</h6>
					<aui:fieldset column="true">
						<aui:input cssClass="lfr-input-text-container" label="Categoria" name="label-category" value="<%= labelCategory %>"   />
						<aui:input cssClass="lfr-input-text-container" label="Categorias" name="label-categories" value="<%= labelForumCategories %>" />	
						<aui:input cssClass="lfr-input-text-container" label="Tópico" name="label-thread" value="<%= labelThread %>"   />
						<aui:input cssClass="lfr-input-text-container" label="Nova Categoria" name="label-new-category" value="<%= labelNewCategory %>"   />
						<aui:input cssClass="lfr-input-text-container" label="Categoria Pai" name="label-parent-category" value="<%= labelParentCategory %>"   />
						<aui:input cssClass="lfr-input-text-container" label="Nova Mensagem" name="label-new-message" value="<%= labelNewMessage %>"   />
						
					</aui:fieldset>
					<aui:fieldset column="true" >
						<aui:input cssClass="lfr-input-text-container" label="Mensagens" name="label-posts" value="<%= labelPosts %>" />
						<aui:input cssClass="lfr-input-text-container" label="Subcategorias" name="label-subcategories" value="<%= labelForumSubcategories %>" />								
						<aui:input cssClass="lfr-input-text-container" label="Tópicos" name="label-threads" value="<%= labelThreads %>"   />	
						<aui:input cssClass="lfr-input-text-container" label="Número de Categorias" name="label-num-of-categories" value="<%= labelNumOfCategories %>"   />
						<aui:input cssClass="lfr-input-text-container" label="Juntar com a categoria pai" name="label-merge-category" value="<%= labelMergeCategory %>"   />
				...
				<aui:fieldset>
					<h6>Ações</h6>
					<aui:fieldset column="true">
						<aui:input cssClass="lfr-input-text-container" label="Bloquear Tópico" name="label-lock-thread" value="<%= labelLockThread %>" />
						<aui:input cssClass="lfr-input-text-container" label="Mover Tópico" name="label-move-thread" value="<%= labelMoveThread %>" />					
					</aui:fieldset>
					<aui:fieldset column="true" >
						<aui:input cssClass="lfr-input-text-container" label="Desbloquear Tópico" name="label-unlock-thread" value="<%= labelUnlockThread %>" />						
					</aui:fieldset>
				</aui:fieldset>
				...
				<aui:fieldset>
					<h6>Mensagens</h6>
					<aui:fieldset column="true">
						<aui:input cssClass="lfr-input-text-container" label="Você não está subscrito em nenhuma categoria" name="msg-no-subscribed-to-categories" value="<%= msgNoSubscribedToCategories %>" />						
						<aui:input cssClass="lfr-input-text-container" label="Não há tópicos nesta categoria" name="msg-no-threads" value="<%= msgNoThreads %>" />					
					</aui:fieldset>
					<aui:fieldset column="true" >
						<aui:input cssClass="lfr-input-text-container" label="Você não está subscrito em nenhum tópico" name="msg-no-subscribed-to-threads" value="<%= msgNoSubscribedToThreads %>" />						
					</aui:fieldset>
				</aui:fieldset>
