...
public class ParticipacaoLocalServiceClp implements ParticipacaoLocalService {
    ...
    public ParticipacaoLocalServiceClp(
        ...
        _methodName3 = "getComunidadesDisponiveis";

        _methodParameterTypes3 = new String[] { "long" };

        _methodName4 = "getDadosComunidade";

        _methodParameterTypes4 = new String[] { "java.util.List" };

        _methodName5 = "getDadosComunidade";

        _methodParameterTypes5 = new String[] {
                "java.util.List", "java.util.Date", "java.util.Date"
            };

        _methodName6 = "getDadosComunidade";

        _methodParameterTypes6 = new String[] { "java.lang.Long" };

        _methodName7 = "getDadosComunidade";
    ...
    public java.util.List<br.gov.camara.edemocracia.portlets.graficos.DadosComunidadeDTO> getDadosComunidade(
        ...
        return (java.util.List<br.gov.camara.edemocracia.portlets.graficos.DadosComunidadeDTO>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<br.gov.camara.edemocracia.portlets.graficos.DadosComunidadeDTO> getDadosComunidade(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName5,
                    ...
                    ClpSerializer.translateInput(dataInicio),
                        
                    ClpSerializer.translateInput(dataFim)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public br.gov.camara.edemocracia.portlets.graficos.DadosComunidadeDTO getDadosComunidade(
        ...
        return (br.gov.camara.edemocracia.portlets.graficos.DadosComunidadeDTO) ClpSerializer.translateOutput(returnObj);
    }
