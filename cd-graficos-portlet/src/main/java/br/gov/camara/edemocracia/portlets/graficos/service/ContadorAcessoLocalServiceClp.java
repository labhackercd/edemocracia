...
public class ContadorAcessoLocalServiceClp implements ContadorAcessoLocalService {
    ...
    public ContadorAcessoLocalServiceClp(
        ...
        _methodName19 = "getCSV";

        _methodParameterTypes19 = new String[] { "long" };

        _methodName20 = "getDadosConsolidados";
    ...
    public br.gov.camara.edemocracia.portlets.graficos.model.ContadorAcesso addContadorAcesso(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(contadorAcesso) });
        } catch (Throwable t) {
        ...
        return (br.gov.camara.edemocracia.portlets.graficos.model.ContadorAcesso) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public br.gov.camara.edemocracia.portlets.graficos.model.ContadorAcesso createContadorAcesso(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { contadorId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public br.gov.camara.edemocracia.portlets.graficos.model.ContadorAcesso deleteContadorAcesso(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { contadorId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public br.gov.camara.edemocracia.portlets.graficos.model.ContadorAcesso fetchContadorAcesso(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName9,
                    _methodParameterTypes9, new Object[] { contadorId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public br.gov.camara.edemocracia.portlets.graficos.model.ContadorAcesso getContadorAcesso(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { contadorId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<br.gov.camara.edemocracia.portlets.graficos.model.ContadorAcesso> getContadorAcessos(
        ...
        return (java.util.List<br.gov.camara.edemocracia.portlets.graficos.model.ContadorAcesso>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public br.gov.camara.edemocracia.portlets.graficos.model.ContadorAcesso updateContadorAcesso(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName15,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(contadorAcesso),
    ...
    public java.util.Map<java.lang.Long, br.gov.camara.edemocracia.portlets.graficos.DadosConsolidados> getDadosConsolidados(
        ...
        return (java.util.Map<java.lang.Long, br.gov.camara.edemocracia.portlets.graficos.DadosConsolidados>) ClpSerializer.translateOutput(returnObj);
    }
}
