...
/**
 * The base implementation of the contribuicao local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.gov.camara.edemocracia.portlets.wikilegis.service.impl.ContribuicaoLocalServiceImpl}.
 * </p>
 *
 * @author robson
 ...
 * @generated
 */
public abstract class ContribuicaoLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ContribuicaoLocalService,
        IdentifiableBean {
    ...
    private ContribuicaoLocalServiceClpInvoker _clpInvoker = new ContribuicaoLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link br.gov.camara.edemocracia.portlets.wikilegis.service.ContribuicaoLocalServiceUtil} to access the contribuicao local service.
     */
    ...
    public Contribuicao addContribuicao(Contribuicao contribuicao)
        ...
        return contribuicaoPersistence.update(contribuicao, false);
    }
     ...
     */
    public Contribuicao createContribuicao(long contribuicaoId) {
        return contribuicaoPersistence.create(contribuicaoId);
    }
    ...
    public Contribuicao deleteContribuicao(long contribuicaoId)
        throws PortalException, SystemException {
        return contribuicaoPersistence.remove(contribuicaoId);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public Contribuicao deleteContribuicao(Contribuicao contribuicao)
        throws SystemException {
        return contribuicaoPersistence.remove(contribuicao);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(Contribuicao.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return contribuicaoPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return contribuicaoPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public Contribuicao fetchContribuicao(long contribuicaoId)
        throws SystemException {
        return contribuicaoPersistence.fetchByPrimaryKey(contribuicaoId);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public Contribuicao getContribuicao(long contribuicaoId)
        throws PortalException, SystemException {
        return contribuicaoPersistence.findByPrimaryKey(contribuicaoId);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return contribuicaoPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<Contribuicao> getContribuicaos(int start, int end)
        throws SystemException {
        return contribuicaoPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getContribuicaosCount() throws SystemException {
        return contribuicaoPersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public Contribuicao updateContribuicao(Contribuicao contribuicao)
        throws SystemException {
        return updateContribuicao(contribuicao, true);
    }
    ...
    public Contribuicao updateContribuicao(Contribuicao contribuicao,
        ...
        return contribuicaoPersistence.update(contribuicao, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("br.gov.camara.edemocracia.portlets.wikilegis.model.Contribuicao",
            contribuicaoLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = contribuicaoPersistence.getDataSource();
