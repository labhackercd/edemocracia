...
public class EixoLocalServiceClp implements EixoLocalService {
    ...
    public EixoLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodName19 = "listarEixosPorGroupId";

        _methodParameterTypes19 = new String[] { "long" };

        _methodName20 = "addEixo";

        _methodParameterTypes20 = new String[] {
                "long", "long", "java.lang.String", "java.lang.String", "long"
            };

        _methodName21 = "updateEixo";

        _methodParameterTypes21 = new String[] {
                "long", "java.lang.String", "java.lang.String", "long", "long"
            };

        _methodName22 = "excluirEixo";

        _methodParameterTypes22 = new String[] {
                "br.gov.camara.edemocracia.portlets.priorizacao.model.Eixo"
            };

        _methodName23 = "excluirEixo";
    ...
    public br.gov.camara.edemocracia.portlets.priorizacao.model.Eixo addEixo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(eixo) });
        } catch (Throwable t) {
    ...
    public br.gov.camara.edemocracia.portlets.priorizacao.model.Eixo createEixo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { eixoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public br.gov.camara.edemocracia.portlets.priorizacao.model.Eixo deleteEixo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { eixoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public br.gov.camara.edemocracia.portlets.priorizacao.model.Eixo fetchEixo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName9,
                    _methodParameterTypes9, new Object[] { eixoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public br.gov.camara.edemocracia.portlets.priorizacao.model.Eixo updateEixo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName15,
                    ...
                    new Object[] { ClpSerializer.translateInput(eixo), merge });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public void excluirEixo(long eixoId)
        ...
        try {
            _invokableLocalService.invokeMethod(_methodName23,
                _methodParameterTypes23, new Object[] { eixoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
