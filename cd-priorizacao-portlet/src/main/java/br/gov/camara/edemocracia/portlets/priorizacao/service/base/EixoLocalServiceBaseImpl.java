...
/**
 * The base implementation of the eixo local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.gov.camara.edemocracia.portlets.priorizacao.service.impl.EixoLocalServiceImpl}.
 * </p>
 *
 * @author robson
 ...
 * @generated
 */
public abstract class EixoLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements EixoLocalService, IdentifiableBean {
    ...
    private EixoLocalServiceClpInvoker _clpInvoker = new EixoLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link br.gov.camara.edemocracia.portlets.priorizacao.service.EixoLocalServiceUtil} to access the eixo local service.
     */
    ...
    public Eixo addEixo(Eixo eixo) throws SystemException {
        eixo.setNew(true);
     ...
     * @return the new eixo
     */
    public Eixo createEixo(long eixoId) {
        return eixoPersistence.create(eixoId);
    }
    ...
    public Eixo deleteEixo(long eixoId) throws PortalException, SystemException {
        return eixoPersistence.remove(eixoId);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public Eixo deleteEixo(Eixo eixo) throws SystemException {
        return eixoPersistence.remove(eixo);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(Eixo.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return eixoPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return eixoPersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return eixoPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public Eixo fetchEixo(long eixoId) throws SystemException {
        return eixoPersistence.fetchByPrimaryKey(eixoId);
    }
    ...
    public Eixo getEixo(long eixoId) throws PortalException, SystemException {
        return eixoPersistence.findByPrimaryKey(eixoId);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return eixoPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<Eixo> getEixos(int start, int end) throws SystemException {
        return eixoPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getEixosCount() throws SystemException {
        return eixoPersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public Eixo updateEixo(Eixo eixo) throws SystemException {
        return updateEixo(eixo, true);
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public Eixo updateEixo(Eixo eixo, boolean merge) throws SystemException {
        eixo.setNew(false);

        return eixoPersistence.update(eixo, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("br.gov.camara.edemocracia.portlets.priorizacao.model.Eixo",
            eixoLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = eixoPersistence.getDataSource();
