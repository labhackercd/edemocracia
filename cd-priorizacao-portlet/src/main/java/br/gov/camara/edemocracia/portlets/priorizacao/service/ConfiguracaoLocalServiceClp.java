...
public class ConfiguracaoLocalServiceClp implements ConfiguracaoLocalService {
    ...
    public ConfiguracaoLocalServiceClp(
        ...
        _methodName19 = "getConfiguracaoPorGrupo";

        _methodParameterTypes19 = new String[] { "long" };

        _methodName20 = "updateConfiguracao";

        _methodParameterTypes20 = new String[] { "long", "int", "int", "boolean" };
    }
    ...
    public java.util.List<br.gov.camara.edemocracia.portlets.priorizacao.model.Configuracao> getConfiguracaos(
        ...
        return (java.util.List<br.gov.camara.edemocracia.portlets.priorizacao.model.Configuracao>) ClpSerializer.translateOutput(returnObj);
    }
