...
import br.gov.camara.edemocracia.portlets.priorizacao.NoSuchConfiguracaoException;
import br.gov.camara.edemocracia.portlets.priorizacao.model.Configuracao;
import br.gov.camara.edemocracia.portlets.priorizacao.model.impl.ConfiguracaoImpl;
import br.gov.camara.edemocracia.portlets.priorizacao.model.impl.ConfiguracaoModelImpl;
...
public class ConfiguracaoPersistenceImpl extends BasePersistenceImpl<Configuracao>
    ...
    public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
        ".List2";
    public static final FinderPath FINDER_PATH_FETCH_BY_G = new FinderPath(ConfiguracaoModelImpl.ENTITY_CACHE_ENABLED,
            ConfiguracaoModelImpl.FINDER_CACHE_ENABLED, ConfiguracaoImpl.class,
            FINDER_CLASS_NAME_ENTITY, "fetchByG",
            new String[] { Long.class.getName() },
            ConfiguracaoModelImpl.GROUPID_COLUMN_BITMASK);
    public static final FinderPath FINDER_PATH_COUNT_BY_G = new FinderPath(ConfiguracaoModelImpl.ENTITY_CACHE_ENABLED,
    ...
    private static final String _FINDER_COLUMN_G_GROUPID_2 = "configuracao.groupId = ?";
    ...
    public void cacheResult(Configuracao configuracao) {
        ...
        FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_G,
    ...
    protected void clearUniqueFindersCache(Configuracao configuracao) {
        FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_G,
            new Object[] { Long.valueOf(configuracao.getGroupId()) });
    }
    ...
    public Configuracao updateImpl(
        ...
        if (isNew) {
            ...
            if ((configuracaoModelImpl.getColumnBitmask() &
                    FINDER_PATH_FETCH_BY_G.getColumnBitmask()) != 0) {
                ...
                FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_G, args);
    ...
    protected Configuracao toUnwrappedModel(Configuracao configuracao) {
        ...
        configuracaoImpl.setCompanyId(configuracao.getCompanyId());
        configuracaoImpl.setGroupId(configuracao.getGroupId());
        configuracaoImpl.setMaximoVotos(configuracao.getMaximoVotos());
        configuracaoImpl.setMaxVotosProposta(configuracao.getMaxVotosProposta());
        configuracaoImpl.setVotacaoAberta(configuracao.isVotacaoAberta());
     ...
     * @throws SystemException if a system exception occurred
     */
    public Configuracao findByG(long groupId)
        throws NoSuchConfiguracaoException, SystemException {
        Configuracao configuracao = fetchByG(groupId);
     ...
     * @throws SystemException if a system exception occurred
     */
    public Configuracao fetchByG(long groupId) throws SystemException {
        return fetchByG(groupId, true);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public Configuracao fetchByG(long groupId, boolean retrieveFromCache)
        throws SystemException {
        ...
        if (retrieveFromCache) {
            result = FinderCacheUtil.getResult(FINDER_PATH_FETCH_BY_G,
                    finderArgs, this);
        }
     ...
     * @throws SystemException if a system exception occurred
     */
    public Configuracao removeByG(long groupId)
        throws NoSuchConfiguracaoException, SystemException {
        Configuracao configuracao = findByG(groupId);
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.br.gov.camara.edemocracia.portlets.priorizacao.model.Configuracao")));
