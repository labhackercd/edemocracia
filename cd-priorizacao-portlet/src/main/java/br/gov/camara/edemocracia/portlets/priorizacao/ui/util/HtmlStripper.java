...
public class HtmlStripper {
	...
	private static final Set<String> ALLOWED_TAGS = new HashSet<String>(
			Arrays.asList(HTMLElementName.BR, HTMLElementName.P,HTMLElementName.EM,
					HTMLElementName.STRONG, HTMLElementName.I,
					HTMLElementName.U, HTMLElementName.SPAN,
					HTMLElementName.OL, HTMLElementName.UL, HTMLElementName.LI,HTMLElementName.A));
	private static final Set<String> ALLOWED_ATTRIBUTES = new HashSet<String>(
			Arrays.asList("alt", "href", "target"));
