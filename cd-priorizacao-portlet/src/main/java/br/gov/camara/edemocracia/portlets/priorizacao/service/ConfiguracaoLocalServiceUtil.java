...
/**
 * The utility for the configuracao local service. This utility wraps {@link br.gov.camara.edemocracia.portlets.priorizacao.service.impl.ConfiguracaoLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class ConfiguracaoLocalServiceUtil {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link br.gov.camara.edemocracia.portlets.priorizacao.service.impl.ConfiguracaoLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static br.gov.camara.edemocracia.portlets.priorizacao.model.Configuracao addConfiguracao(
    ...
    */
    public static br.gov.camara.edemocracia.portlets.priorizacao.model.Configuracao createConfiguracao(
        long configuracaoId) {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static br.gov.camara.edemocracia.portlets.priorizacao.model.Configuracao deleteConfiguracao(
        long configuracaoId)
    ...
    */
    ...
    public static br.gov.camara.edemocracia.portlets.priorizacao.model.Configuracao fetchConfiguracao(
        long configuracaoId)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static br.gov.camara.edemocracia.portlets.priorizacao.model.Configuracao getConfiguracao(
        long configuracaoId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<br.gov.camara.edemocracia.portlets.priorizacao.model.Configuracao> getConfiguracaos(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    public static br.gov.camara.edemocracia.portlets.priorizacao.model.Configuracao getConfiguracaoPorGrupo(
        ...
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().getConfiguracaoPorGrupo(groupId);
    }
