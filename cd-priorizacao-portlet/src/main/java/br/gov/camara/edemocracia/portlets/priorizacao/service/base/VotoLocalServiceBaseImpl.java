...
/**
 * The base implementation of the voto local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.gov.camara.edemocracia.portlets.priorizacao.service.impl.VotoLocalServiceImpl}.
 * </p>
 *
 * @author robson
 ...
 * @generated
 */
public abstract class VotoLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements VotoLocalService, IdentifiableBean {
    ...
    private VotoLocalServiceClpInvoker _clpInvoker = new VotoLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link br.gov.camara.edemocracia.portlets.priorizacao.service.VotoLocalServiceUtil} to access the voto local service.
     */
    ...
    public Voto addVoto(Voto voto) throws SystemException {
        voto.setNew(true);

        return votoPersistence.update(voto, false);
    }
     ...
     * @return the new voto
     */
    public Voto createVoto(long votoId) {
        return votoPersistence.create(votoId);
    }
    ...
    public Voto deleteVoto(long votoId) throws PortalException, SystemException {
        return votoPersistence.remove(votoId);
    }
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public Voto deleteVoto(Voto voto) throws SystemException {
        return votoPersistence.remove(voto);
    }

    public DynamicQuery dynamicQuery() {
        Class<?> clazz = getClass();

        return DynamicQueryFactoryUtil.forClass(Voto.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return votoPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return votoPersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return votoPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public Voto fetchVoto(long votoId) throws SystemException {
        return votoPersistence.fetchByPrimaryKey(votoId);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public Voto getVoto(long votoId) throws PortalException, SystemException {
        return votoPersistence.findByPrimaryKey(votoId);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return votoPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<Voto> getVotos(int start, int end) throws SystemException {
        return votoPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getVotosCount() throws SystemException {
        return votoPersistence.countAll();
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public Voto updateVoto(Voto voto) throws SystemException {
        return updateVoto(voto, true);
    }
     ...
     */
    @Indexable(type = IndexableType.REINDEX)
    public Voto updateVoto(Voto voto, boolean merge) throws SystemException {
        voto.setNew(false);

        return votoPersistence.update(voto, merge);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("br.gov.camara.edemocracia.portlets.priorizacao.model.Voto",
            votoLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = votoPersistence.getDataSource();
