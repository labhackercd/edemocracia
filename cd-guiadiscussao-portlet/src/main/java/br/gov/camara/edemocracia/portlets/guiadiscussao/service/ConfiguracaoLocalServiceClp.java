...
public class ConfiguracaoLocalServiceClp implements ConfiguracaoLocalService {
    ...
    public ConfiguracaoLocalServiceClp(
        ...
        _methodName20 = "marcarFaseComoAtual";
    ...
    public br.gov.camara.edemocracia.portlets.guiadiscussao.model.Configuracao addConfiguracao(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(configuracao) });
        } catch (Throwable t) {
        ...
        return (br.gov.camara.edemocracia.portlets.guiadiscussao.model.Configuracao) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public br.gov.camara.edemocracia.portlets.guiadiscussao.model.Configuracao createConfiguracao(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { configuracaoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public br.gov.camara.edemocracia.portlets.guiadiscussao.model.Configuracao deleteConfiguracao(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { configuracaoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public br.gov.camara.edemocracia.portlets.guiadiscussao.model.Configuracao fetchConfiguracao(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName9,
                    _methodParameterTypes9, new Object[] { configuracaoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public br.gov.camara.edemocracia.portlets.guiadiscussao.model.Configuracao getConfiguracao(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { configuracaoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<br.gov.camara.edemocracia.portlets.guiadiscussao.model.Configuracao> getConfiguracaos(
        ...
        return (java.util.List<br.gov.camara.edemocracia.portlets.guiadiscussao.model.Configuracao>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public br.gov.camara.edemocracia.portlets.guiadiscussao.model.Configuracao updateConfiguracao(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName15,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(configuracao),
