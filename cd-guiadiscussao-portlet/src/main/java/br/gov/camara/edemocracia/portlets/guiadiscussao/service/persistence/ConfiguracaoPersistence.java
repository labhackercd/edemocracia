...
public interface ConfiguracaoPersistence extends BasePersistence<Configuracao> {
    ...
    */
    public br.gov.camara.edemocracia.portlets.guiadiscussao.model.Configuracao create(
        long configuracaoId);
    ...
    */
    public br.gov.camara.edemocracia.portlets.guiadiscussao.model.Configuracao remove(
        long configuracaoId)
        throws br.gov.camara.edemocracia.portlets.guiadiscussao.NoSuchConfiguracaoException,
            com.liferay.portal.kernel.exception.SystemException;

    public br.gov.camara.edemocracia.portlets.guiadiscussao.model.Configuracao updateImpl(
        br.gov.camara.edemocracia.portlets.guiadiscussao.model.Configuracao configuracao,
        boolean merge)
    ...
    * @throws SystemException if a system exception occurred
    */
    public br.gov.camara.edemocracia.portlets.guiadiscussao.model.Configuracao findByPrimaryKey(
        long configuracaoId)
        throws br.gov.camara.edemocracia.portlets.guiadiscussao.NoSuchConfiguracaoException,
            com.liferay.portal.kernel.exception.SystemException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public br.gov.camara.edemocracia.portlets.guiadiscussao.model.Configuracao fetchByPrimaryKey(
        long configuracaoId)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public br.gov.camara.edemocracia.portlets.guiadiscussao.model.Configuracao findByGroupId(
        long groupId)
        throws br.gov.camara.edemocracia.portlets.guiadiscussao.NoSuchConfiguracaoException,
            com.liferay.portal.kernel.exception.SystemException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public br.gov.camara.edemocracia.portlets.guiadiscussao.model.Configuracao fetchByGroupId(
        long groupId)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public java.util.List<br.gov.camara.edemocracia.portlets.guiadiscussao.model.Configuracao> findAll()
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public br.gov.camara.edemocracia.portlets.guiadiscussao.model.Configuracao removeByGroupId(
        long groupId)
        throws br.gov.camara.edemocracia.portlets.guiadiscussao.NoSuchConfiguracaoException,
            com.liferay.portal.kernel.exception.SystemException;
