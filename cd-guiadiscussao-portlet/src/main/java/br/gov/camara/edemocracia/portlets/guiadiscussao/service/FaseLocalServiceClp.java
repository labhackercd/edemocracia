...
public class FaseLocalServiceClp implements FaseLocalService {
    ...
    public FaseLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodName19 = "criaFase";

        _methodParameterTypes19 = new String[] {
                "br.gov.camara.edemocracia.portlets.guiadiscussao.model.Fase"
            };

        _methodName20 = "getFasesByConfiguracaoId";

        _methodParameterTypes20 = new String[] { "long" };

        _methodName21 = "excluirFase";

        _methodParameterTypes21 = new String[] { "long" };

        _methodName22 = "moverFaseParaCima";

        _methodParameterTypes22 = new String[] { "long" };

        _methodName23 = "moverFaseParaBaixo";
    ...
    public br.gov.camara.edemocracia.portlets.guiadiscussao.model.Fase addFase(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(fase) });
        } catch (Throwable t) {
        ...
        return (br.gov.camara.edemocracia.portlets.guiadiscussao.model.Fase) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public br.gov.camara.edemocracia.portlets.guiadiscussao.model.Fase createFase(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { faseId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public br.gov.camara.edemocracia.portlets.guiadiscussao.model.Fase deleteFase(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { faseId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public br.gov.camara.edemocracia.portlets.guiadiscussao.model.Fase fetchFase(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName9,
                    _methodParameterTypes9, new Object[] { faseId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public br.gov.camara.edemocracia.portlets.guiadiscussao.model.Fase getFase(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { faseId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<br.gov.camara.edemocracia.portlets.guiadiscussao.model.Fase> getFases(
        ...
        return (java.util.List<br.gov.camara.edemocracia.portlets.guiadiscussao.model.Fase>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public br.gov.camara.edemocracia.portlets.guiadiscussao.model.Fase updateFase(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName15,
                    ...
                    new Object[] { ClpSerializer.translateInput(fase), merge });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<br.gov.camara.edemocracia.portlets.guiadiscussao.model.Fase> getFasesByConfiguracaoId(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName20,
                    _methodParameterTypes20, new Object[] { configuracaoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public void excluirFase(long faseId)
        ...
        try {
            _invokableLocalService.invokeMethod(_methodName21,
                _methodParameterTypes21, new Object[] { faseId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public void moverFaseParaCima(long faseId)
        ...
        try {
            _invokableLocalService.invokeMethod(_methodName22,
                _methodParameterTypes22, new Object[] { faseId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);

            if (t instanceof br.gov.camara.edemocracia.portlets.guiadiscussao.CantFaseMoveUpException) {
                throw (br.gov.camara.edemocracia.portlets.guiadiscussao.CantFaseMoveUpException) t;
            }
    ...
    public void moverFaseParaBaixo(long faseId)
        ...
        try {
            _invokableLocalService.invokeMethod(_methodName23,
                _methodParameterTypes23, new Object[] { faseId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);

            if (t instanceof br.gov.camara.edemocracia.portlets.guiadiscussao.CantFaseMoveDownException) {
                throw (br.gov.camara.edemocracia.portlets.guiadiscussao.CantFaseMoveDownException) t;
            }
