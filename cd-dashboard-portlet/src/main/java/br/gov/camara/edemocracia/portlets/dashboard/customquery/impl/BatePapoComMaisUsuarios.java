...
public class BatePapoComMaisUsuarios extends QueryExecutor {
	...
	protected List<RecursoDTO> listar(Connection connection, Configuracao config, long companyId) throws SQLException {
		...
		String sql = SQLBuilder.buildSQLBatePaposComMaisUsuarios(config);
	...
	public CacheKey getChaveCache() {
		return CacheKey.BATEPAPO_USUARIOS;
	}
