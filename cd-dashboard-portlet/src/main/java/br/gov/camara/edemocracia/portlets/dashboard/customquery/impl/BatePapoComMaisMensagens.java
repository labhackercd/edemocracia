...
public class BatePapoComMaisMensagens extends QueryExecutor {
	...
	protected List<RecursoDTO> listar(Connection connection, Configuracao config, long companyId) throws SQLException {
		...
		String sql = SQLBuilder.buildSQLBatePaposComMaisMensagens(config);
	...
	public CacheKey getChaveCache() {
		return CacheKey.BATEPAPO_MENSAGENS;
	}
