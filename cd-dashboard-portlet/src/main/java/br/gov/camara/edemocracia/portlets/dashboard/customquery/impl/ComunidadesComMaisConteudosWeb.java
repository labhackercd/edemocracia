...
public class ComunidadesComMaisConteudosWeb extends QueryExecutor {
	...
	protected List<RecursoDTO> listar(Connection connection, Configuracao config, long companyId) throws SQLException {
		...
		String sql = SQLBuilder.buildSQLComunidadesComMaisConteudosWebCriados(config);
	...
	public CacheKey getChaveCache() {
		return CacheKey.CONTEUDOS_WEB_COMUNIDADES;
	}
