...
public class ComunidadesComMaisPaginas extends QueryExecutor {
	...
	protected List<RecursoDTO> listar(Connection connection, Configuracao config, long companyId) throws SQLException {
		...
		String sql = SQLBuilder.buildSQLComunidadesComMaisPaginasCriadas(config);
	...
	public CacheKey getChaveCache() {
		return CacheKey.PAGINAS_COMUNIDADES;
	}
