...
public class ComunidadesComMaisDocumentos extends QueryExecutor {
	...
	protected List<RecursoDTO> listar(Connection connection, Configuracao config, long companyId) throws SQLException {
		...
		String sql = SQLBuilder.buildSQLComunidadesComMaisDocumentosCriados(config);
	...
	public CacheKey getChaveCache() {
		return CacheKey.DOCUMENTOS_COMUNIDADES;
	}
